...
public class EditorConfiguration {
    ...
    public EditorConfiguration(PlayerTaskX plugin) {
        this.plugin = plugin;
        configFile = new File(plugin.getDataFolder(), "editor.yml");
    }
    ...
    public void reloadConfig() {
        ...
        final InputStream defConfigStream = plugin.getResource("editor.yml");
